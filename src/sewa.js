...
const expiredCheck = (angga, _dir) => {
    setInterval(() => {
        ...
        if (position !== null) {
            ...
            angga.sendMessage(_dir[position].id, { text: `Masa sewa di grup ini telah habis, bot otomatis keluar!` })
            .then( res => {
              angga.groupLeave(_dir[position].id)
